...
const Table = ({ header, actions = null, data }: { header: string[], actions: IActions[] | null, data: IBeneficiary[] }) => {
  ...
  /**
   * This function builds the header of the table based on the `header` prop. It maps on the header array and for each element of
   * the array it builds a header row using the HTML `th` tag.
   */
